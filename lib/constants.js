...
const title = new Document({ pageContent: "[Title] Christopher Carnicle Resume", metadata: { source: "1" } });
const section1 = new Document({ pageContent: "[SECTION 1] EXPERIENCE", metadata: { source: "2" } });
const job1 = new Document({ pageContent: `[SUBSECTION] aiSports - CryptoDFS (Daily Fantasy Sports). Technical Founder (08/2020 to Present)\n[PARAGRAPH]
...
* Javascript, Node.js, Material-UI, React, Firebase (Firestore, Functions, Authentication, Analytics), Google Cloud Platform: (BigQuery, Storage, Vertex-AI), Solidity, Cadence, Stable-Diffusion`, metadata: { source: "3" } });
const job2 = new Document({ pageContent: `[SUBSECTION] Scouture, Inc. Management Consultant (08/2019 - 11/2022)\n[PARAGRAPH]
 * Handled all day-to-day business for Scouture, Inc. We hosted city tours for out-of-town candidates of GAP, Inc.
 * Built the Scouture website & automated business processes on Google Sheets using Google Apps Script (JavaScript).`, metadata: { source: "4" } });

const job3 = new Document({ pageContent: `[SUBSECTION] LocalFriend Travel | CEO & Founder 02/2019 - 05/2020\n[PARAGRAPH]
 * Co-developed the LocalFriend IOS app as a tool to help travelers connect directly with locals in foreign countries. I decided to close LocalFriend after the pandemic shut down all international travel.`, metadata: { source: "5" } });

const job4 = new Document({ pageContent: `[SUBSECTION] Theranos, Inc. Global Supply Manager. Palo Alto, CA (04/2013 - 12/2013)\n[PARAGRAPH]
 ...
 * Reduced PCB component spend by 30% by negotiating pricing with distribution partners.`, metadata: { source: "6" } });

const section2 = new Document({ pageContent: `[SECTION 2] PROFICIENCIES
[PARAGRAPH]
...
const section3 = new Document({ pageContent: `[SECTION] EDUCATION
[PARAGRAPH]
 * University of Texas at Austin | B.S. in Computer Engineering (08/2007 - 05/2011)
   ...
   * Major GPA: 3.37/4.0`, metadata: { source: "8" } });
